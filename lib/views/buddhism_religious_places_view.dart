...
class BuddhismReligiousPlacesView extends GetView<ReligiousPlacesController> {
  const BuddhismReligiousPlacesView({super.key});

  @override
  Widget build(BuildContext context) {
    final animationController = Get.put(AppAnimationController(), tag: 'buddhism');
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              _buildHeader('Buddhism'),
              Expanded(
                child: _buildPlacesList('Buddhism', animationController),
              ),
            ],
          ),
        ),
