...
class ChristianityReligiousPlacesView extends GetView<ReligiousPlacesController> {
  const ChristianityReligiousPlacesView({super.key});

  @override
  Widget build(BuildContext context) {
    final animationController = Get.put(AppAnimationController(), tag: 'christianity');
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              _buildHeader('Christianity'),
              Expanded(
                child: _buildPlacesList('Christianity', animationController),
              ),
            ],
          ),
        ),
